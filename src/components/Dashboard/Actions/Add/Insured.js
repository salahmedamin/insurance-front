          ...
          <div className="col-12">
            <div className="title">
              <h4>
                ADD INSURED
                {error ? (
                  <span className="ml-2 text-dark" style={{ fontSize: 12 }}>
                    {error}
                  </span>
                ) : null}
              </h4>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  className={`form-control${
                    errors.matricule ? " border border-danger" : ""
                  }`}
                  {...register("matricule", {
                    maxLength: 8,
                    minLength: 8,
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  type="text"
                  className={`form-control${
                    errors.nom ? " border border-danger" : ""
                  }`}
                  {...register("nom", {
                    required: true,
                    pattern: /^[a-zA-Z ]+$/,
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  type="text"
                  className={`form-control${
                    errors.prenom ? " border border-danger" : ""
                  }`}
                  {...register("prenom", {
                    required: true,
                    pattern: /^[a-zA-Z ]+$/,
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input
                  type="date"
                  className={`form-control${
                    errors.dateNaiss ? " border border-danger" : ""
                  }`}
                  {...register("dateNaiss", {
                    validate: (date) => calcAge(String(date)) >= 0,
                  })}
                />
              </div>
            </div>
